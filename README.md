...
| `stationaryUpdateInterval`                | `Number`          | Android      | The minimum time interval between location updates while stationary in minutes.                                                                                                                                                                                                                                                    | DIS         | 15                         | 
